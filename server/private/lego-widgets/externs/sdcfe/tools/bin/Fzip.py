...
# $Id: Fzip.py 12568 2012-10-10 05:45:20Z liyubei $ 
...
def zip_css(input, options):
  ...
  if proc.returncode != 0:
    ...
    # options.output.write(copyleft)
    # http://yuilibrary.com/projects/yuicompressor/ticket/2528127
    # background:none -> background:0
    # 恢复过来.
    stdoutdata = stdoutdata.replace('background:0', 'background:none');
    options.output.write(stdoutdata)
