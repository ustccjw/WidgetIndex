...
#{{{
  ...
  deploy_og.add_option("--deploy_style", action="store_true", default=False,
                       dest="deploy_style", help="Run ad style deploy.")
  deploy_og.add_option('--disable_ftangram', action='store_true', default=False,
                       dest='disable_ftangram', help="Disable Ftangram phrase.")
  deploy_og.add_option('--output_file_template',
                       dest='output_file_template',
                       default=None,
                       help="This template was used to generate `index.html' file.")
  deploy_og.add_option("--ad_style_wrapper",
                       dest="ad_style_wrapper",
                       default=None,
                       help="Ad style output wrapper, default is None.")
  deploy_og.add_option("--ad_template_wrapper",
  ...
  common_og.add_option('-a',
                       '--compiler_jar',
                       dest='compiler_jar',
                       default=os.path.normpath(os.path.join(os.path.dirname(__file__), '..', 'lib', 'gcc.jar')),
                       action='store',
  ...
  common_og.add_option("--noisy", "--enable_noisy", action="store_true", default=False,
