        ...
        parse: function (str, callback) {
            ...
            root.toCSS = (function (evaluate) {
                ...
                return function (options, variables) {
                    var frames = [], importError, imports = [];
                    ...
                    try {
                        var css = evaluate.call(this, { frames: frames, imports: imports })
    ...
    eval: function (env) {
        ...
        if (this.css) {
            ...
            for (var i = 0; i < ruleset.rules.length; i++) {
                // songao: check if multiple imported
                if (ruleset.rules[i] instanceof tree.Import
                      && (!ruleset.rules[i].once || env.imports.indexOf(ruleset.rules[i].path) === -1)) {
                    ruleset.rules[i].once && env.imports.unshift(ruleset.rules[i].path);
                    Array.prototype
                         .splice
                         .apply(ruleset.rules,
