...
this.Server.prototype.mimeType = function(pathname) {
  return mime.contentTypes[path.extname(pathname).slice(1)] || 'application/octet-stream';
}
...
this.Server.prototype.respond = function (pathname, status, _headers, files, stat, req, res, finish) {
    ...
    if (req.headers['origin']) {
        ...
        headers['Access-Control-Allow-Headers'] = 'X-Request-By,Content-Type,X-Requested-With';
    } else {
