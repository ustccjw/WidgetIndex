 ...
 * $Id: tangram.externs.js 18653 2013-03-27 07:43:58Z fanxueliang $
 *
 **************************************************************************/
 ...
 * @type {Object}
 */
Object.prototype._instances;

/**
 * addSingletonGetter以后保留的函数
 * @type {Function}
 */
Object.prototype.getInstance;
 ...
 * @type {boolean}
 */
baidu.fx.Timeline.prototype.disposed;
 ...
 *  ontimeout:function((XMLHttpRequest|ProgressEvent)),
 *  onsuccess:function(XMLHttpRequest),
 *  onfailure:function(XMLHttpRequest),
 *  onbeforerequest:function(XMLHttpRequest),
 *  onstatus:function(XMLHttpRequest, number),
 *  onloadstart:function(ProgressEvent),
 *  onprogress:function(ProgressEvent),
 *  onabort:function(ProgressEvent),
 *  onerror:function(ProgressEvent),
 *  onload:function(ProgressEvent),
 *  onloadend:function(ProgressEvent)}|!Object}
 */
 ...
 * @return {XMLHttpRequest}
 */
baidu.ajax.request2 = function(url, options) {};
...
/**
 * @param {Array|NodeList} source 需要遍历的数组.
 * @param {function(*, number)} iterator 迭代器，如果返回false，则终止迭代.
...
/**
 * 为目标元素添加一次事件绑定
 * @param {Node|string} element 目标元素或目标元素id
 * @param {string} type 事件类型
 * @param {Function} listener 需要添加的监听器
 * @return {Element} 目标元素
 */
 ...
 *    当鼠标在元素内部移动的时候不会多次触发.
 */
baidu.event._eventFilter.mouseenter = function(element,type, listener) {} 
 ...
 *    当鼠标在元素区域内部移动的时候不会触发.
 */
baidu.event._eventFilter.mouseleave = function(element,type, listener) {};
...
/**
 * 获取目标元素的直接子元素列表
 * @param {Node|string} element 目标元素或目标元素的id
...
/**
 * 判断一个元素是否包含另一个元素
 * @param {Node|string} container 包含元素或元素的id
 * @param {Node|string} contained 被包含元素或元素的id
 ...
 * 拖动指定的DOM元素
 * FIXME
 * @param {Node|string} element 元素或者元素的id
...
/**
 * 检查两个元素是否相交
 * @param {Node|string} element1 要检查的元素或元素的id
 * @param {Node|string} element2 要检查的元素或元素的id
 ...
 * @param {Node|string} element 容器元素或者容器元素的ID
...
/**
 * 查询一个元素是否包含指定的属性
 * @param {Node|string} element DOM元素或元素的id
...
/**
 * 将目标元素添加到基准元素之后
 * @param {Node|string} newElement 被添加的目标元素
 * @param {Node|string} existElement 基准元素
 ...
 * @param {string|Node=} opt_element 开始搜索的元素，默认是document。
 ...
 * 1. 非数字值(medium)
 * 2. em/px在不同的属性中混用
 * @param {Node|string} element 元素或DOM元素的id
 ...
 * @param {Node|string} element 需要改变大小的元素或者元素的id.
...
/**
 * @param {Node|string} node 需要包装的节点.
 ...
 */
baidu.string.fast_ellipse = function(text, width, opt_dots) {};
...
/**
 * 启动时间线
 * @return {baidu.fx.Timeline} 类实例.
 */
baidu.fx.Timeline.prototype.launch = function() {};

/**
 * 重新计算 schedule，以产生各种适合需求的进度曲线
 * @param {Function} percent 算子.
 * @return {Function}
 */
baidu.fx.Timeline.prototype.transition = function(percent) {};

/**
 * 撤销当前时间线的操作，并引发 restore() 接口函数的操作
 */
baidu.fx.Timeline.prototype.cancel = function() {};

/**
 * 直接将时间线运行到结束点
 */
baidu.fx.Timeline.prototype.end = function() {};

/**
 * @param {Node}  element 添加效果的DOM元素.
 * @param {Object} options 时间线的配置参数对象.
 * @param {string=} opt_fxName 效果名（可选）.
 * @return {baidu.fx.Timeline}  时间线类的一个实例
 */
baidu.fx.create = function(element, options, opt_fxName) {};

/**
 * @param {string|Node} element 元素或者元素的ID
 ...
 */
baidu.data.storage.get = function(key, callback){};
 ...
 */
baidu.data.storage.set = function(key, value, callback, options){};
...
/**
 * @param {number} height 调整到的高度
 */
baidu.app.setHeight = function(height) {};
...
/**
 * @param {string} template 模板片段.
 * @param {Object} view 数据源.
 * @param {Object=} partials 干什么用的查文档去，我也说不清楚.
 * @return {string}
 */
 ...
 * 使用示例：
 * var _hmt = _hmt || [];
 * _hmt.push(['_trackPageview', '/#this/is/aother/fake/url']);
 * _hmt.push(['_setReferrerOverride', '/the/new/referrer']);
 */
var _hmt = {};

/**
 * @param {Array} actions 自定义的操作
 */
_hmt.push = function(actions) {
    // 例如：
    // _hmt.push(['_trackPageview', '/#this/is/aother/fake/url']);
    // _hmt.push(['_setReferrerOverride', '/the/new/referrer']);
};
...
/**
 * 贴吧的post_video_url.js
 * @type {Object}
 */
var Post_Video_URL = {};

/**
 * @param {string} url 播放页面地址.
 * @return {string}
 */
Post_Video_URL.convert = function(url) {};

/**
 * @param {string} swf_url flash地址.
 * @return {string}
 */
Post_Video_URL.filter_param = function(swf_url) {};
...
bdPass.api.login = {};
/**
 * @param {Object} obj 登录初始化参数.
 */
bdPass.api.login.init = function(obj) {};
 ...
 * @constructor
 */
var opui_scroll_scrollbarv = function(){};

/**
 * ps阿拉丁滚动条实例重绘
 * @type {Function}
 */
opui_scroll_scrollbarv.prototype.render = function(){};
