 ...
 * 删除所有的事件监听处理逻辑.
 */
base.EventDispatcher.prototype.dispose = function() {
    this._listeners = {};
}
 ...
 * @param {Function} listener 监听器.
 */
base.EventDispatcher.prototype.registerListener = function(eventType, listener) {
    var registry = base.EventDispatcher._registry;
    registry.push({
        'eventType' : eventType,
        'subscriber' : this,
        'listener' : listener
 ...
 * @param {Function} listener 监听器.
 */
base.EventDispatcher.prototype.unregisterListener = function(eventType, listener) {
    var registry = base.EventDispatcher._registry;
 ...
 * @return {boolean} 返回值.
 */
base.EventDispatcher.prototype.publish = function(eventType, var_args) {
    var registry = base.EventDispatcher._registry,
