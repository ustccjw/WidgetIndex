package baidu.lib.images {
    ...
    /**
     * JPG图片数据生成器（注:从Adobe as3corelib 库引入并修改）
     * @author xiaokun
     */
    public class JPGEncoder {
        ...
        /**
         * 构造函数
         * @param	quality			<Number>图像质量指数（1-100）
         */
        public function JPGEncoder(quality:Number = 80) {
            if (quality <= 0) {
                quality = 1;
            }
            if (quality > 100) {
        ...
        /**
         * 根据给定的BitmapData对象生成JPG图片数据
         * @param	img				<BitmapData>给定图像的BitmapData对象
         * @return					<ByteArray>生成的JPG图片ByteArray数据
         */
        public function encode(image:BitmapData):ByteArray {
            ...
            if ( bytepos >= 0 ) {
                var fillbits:Object = new Object();
        ...
        private var ZigZag:Array = [0, 1, 5, 6,14,15,27,28,
        ...
        private function computeHuffmanTbl(nrcodes:Array, std_table:Array):Array {
            ...
            for (var k:int = 1;k <= 16; k++) {
                for (var j:int = 1;j <= nrcodes[k]; j++) {
                    HT[std_table[pos_in_table]] = new Object();
        ...
        private var std_ac_luminance_values:Array = [0x01,0x02,0x03,0x00,0x04,0x11,0x05,0x12,
        ...
        private var std_ac_chrominance_values:Array = [0x00,0x01,0x02,0x03,0x11,0x04,0x05,0x21,
        ...
        private function writeBits(bs:Object):void {
        ...
        private function processDU(CDU:Array, fdtbl:Array, DC:Number, HTDC:Array, HTAC:Array):Number {
            var EOB:Object = HTAC[0x00];
            var M16zeroes:Object = HTAC[0xF0];
            var i:int;
