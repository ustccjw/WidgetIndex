...
/**
 * src/ad/widget/imageplus/v2/util.js ~ 2014/05/02 17:02:00
...
goog.provide('ad.widget.imageplus.v2.util');

ad.widget.imageplus.v2.util = {
    /**
     * 更新icon的配置
     * 根据行业id，变成对应的行业字符串
     *
     ...
     *
     * @param {ad.widget.IsolatedWidgetContainer} box .
    ...
    setupLog: function (box, calcTimeQuery, opt_notAllLinkIsolated) {
        ...
        if (opt_notAllLinkIsolated) {
            ad.widget.imageplus.v2.util._bindLogEvent(root, box, calcTimeQuery);
        }

        box.afterLoaded(function (isolatedRoot) {
            ad.widget.imageplus.v2.util._bindLogEvent(isolatedRoot, box, calcTimeQuery);
        });

        // 绑定heatmap相关事件
        ad.widget.imageplus.v2.util._bindHeatMap(root, box);
    },
    /**
     ...
     * @param {ad.widget.IsolatedWidgetContainer} box box实例
     */
    _bindHeatMap: function (root, box) {
        ...
        var makeClickListener = function (opt_iframe) {
            return function (event) {
                var query = ad.widget.imageplus.v2.util._getClickPosQuery(
