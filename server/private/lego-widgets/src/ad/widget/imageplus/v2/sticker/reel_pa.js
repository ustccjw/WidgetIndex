...
/**
 * src/ad/widget/imageplus/v2/sticker/reel_pa.js ~ 2014/09/03 19:09:09
...
goog.include('ad/widget/imageplus/v2/sticker/reel_pa.less');
goog.include('ad/widget/imageplus/v2/sticker/reel_pa.html');

goog.provide('ad.widget.imageplus.v2.sticker.ReelPa');
 ...
 */
ad.widget.imageplus.v2.sticker.ReelPa = function(data) {
    /**
     * 当前Widget的View模板名称.
     * @type {string}
     */
    this._view = 'AD_ad_widget_imageplus_v2_sticker_reel_pa';
...
baidu.inherits(ad.widget.imageplus.v2.sticker.ReelPa, ad.widget.imageplus.v2.BaseWidget);

/** @override */
ad.widget.imageplus.v2.sticker.ReelPa.prototype.enterDocument = function() {
    ad.widget.imageplus.v2.sticker.ReelPa.superClass.enterDocument.call(this);
...
/** @override */
ad.widget.imageplus.v2.sticker.ReelPa.prototype.bindEvent = function() {
    ad.widget.imageplus.v2.sticker.ReelPa.superClass.bindEvent.call(this);

    // CODE HERE
};

/** @override */
ad.widget.imageplus.v2.sticker.ReelPa.prototype.patchData = function() {
    this._firstShowTime = this.getData('box.first_show_time', 5000);

    ad.widget.imageplus.v2.sticker.ReelPa.superClass.patchData.apply(this, arguments);
};
 ...
 */
ad.widget.imageplus.v2.sticker.ReelPa.prototype.widthEffect = function(from, to, opt_finish, opt_start) {
    var me = this;
    var duration = 500;
 ...
 */
ad.widget.imageplus.v2.sticker.ReelPa.prototype.expandPaper = function(opt_logSilent) {
    var me = this;
 ...
 * @param {boolean=} opt_logSilent 是否不发送日志
 */
ad.widget.imageplus.v2.sticker.ReelPa.prototype.withdrawPaper = function(opt_logSilent) {
    var me = this;
 ...
 */
ad.widget.imageplus.v2.sticker.ReelPa.prototype._firstShow = function (loaderApi) {
    var me = this;
 ...
 * 开始跳动
 */
ad.widget.imageplus.v2.sticker.ReelPa.prototype.startBounce = function() {
    var me = this;
 ...
 * 停止跳动
 */
ad.widget.imageplus.v2.sticker.ReelPa.prototype.stopBounce = function() {
    if (this._bounceFx) {
        try {
            this._bounceFx.end();
        }
 ...
 */
ad.widget.imageplus.v2.sticker.ReelPa.prototype.bounceEffect = function(from, to, duration) {
    var me = this;
    var element = me.g(me.getId('paper'));
    var fx = ad.fx.create(element, {
