...
/**
 * src/ad/widget/imageplus/m/base_box.js ~ 2014/09/04 12:38:59
...
goog.provide('ad.widget.imageplus.m.BaseBox');

/**
 * @constructor
 * @param {Object} data 数据集合.
 * @extends {ad.widget.FixedIsolatedWidgetContainer}
 */
ad.widget.imageplus.m.BaseBox = function (data) {
    ad.widget.FixedIsolatedWidgetContainer.call(this, data);
...
baidu.inherits(ad.widget.imageplus.m.BaseBox, ad.widget.FixedIsolatedWidgetContainer);

/** @override */
ad.widget.imageplus.m.BaseBox.prototype.patchData = function () {
    if (this._data) {
        ad.widget.imageplus.m.util.updateRealUrl(this._data);
        this._thirdPartyContent = this.getData('box.third_party_content', false);
        this._isolatedHostWidth = this.getData('box.content_width', 0);
        this._isolatedHostHeight = this.getData('box.content_height', 0);
    }
};
 ...
 */
ad.widget.imageplus.m.BaseBox.prototype.getLoaderApi = function () {
 ...
 */
ad.widget.imageplus.m.BaseBox.prototype.async = function (action, scope, var_args) {
    var me = this;
...
/** @override */
ad.widget.imageplus.m.BaseBox.prototype.enterDocument = function () {
    ad.widget.imageplus.m.BaseBox.superClass.enterDocument.call(this);
    var me = this;
    ...
    ad.widget.imageplus.m.util.setupLog(
        me,
 ...
 */
ad.widget.imageplus.m.BaseBox.prototype.enterAd = function (loaderApi) {};
 ...
 */
ad.widget.imageplus.m.BaseBox.prototype.enterAdOnLoad = function (loaderApi, isolatedRoot) {};
 ...
 */
ad.widget.imageplus.m.BaseBox.prototype.relayout = function (imgRect) {
 ...
 * 计算广告点击中的日志query
 *
 * @return {string} 日志链接地址后缀query，被ad.widget.imageplus.m.util.setupLog方法使用
 */
ad.widget.imageplus.m.BaseBox.prototype.calcLinkQuery = function () {
 ...
 *          }
 */
ad.widget.imageplus.m.BaseBox.prototype.onAdShow = function (event) {
    // 如果在display none的时候显示广告，那么广告内部高宽计算可能会出错
    // 所以必须在show的时候重新计算下位置
    this.relayout(this.getLoaderApi().getImgRect());
};
 ...
 *          }
 */
ad.widget.imageplus.m.BaseBox.prototype.onAdHide = function (event) {};
 ...
 *          }
 */
ad.widget.imageplus.m.BaseBox.prototype.onAdRelease = function (event) {
    this.released = true;
};
 ...
 *          }
 */
ad.widget.imageplus.m.BaseBox.prototype.onAdResize = function (event, imgRect) {
 ...
 */
ad.widget.imageplus.m.BaseBox.prototype.closeAd = function (opt_done, opt_triggerByWidget) {
    var me = this;
    me.forceHiding = true;
 ...
 * @param {boolean=} opt_triggerByWidget 是否由子widget通过事件触发
 */
ad.widget.imageplus.m.BaseBox.prototype.minimizeAd = function (opt_done, opt_triggerByWidget) {};
 ...
 * @param {boolean=} opt_triggerByWidget 是否由子widget通过事件触发
 */
ad.widget.imageplus.m.BaseBox.prototype.maximizeAd = function (opt_done, opt_triggerByWidget) {};
 ...
 * @param {boolean=} opt_triggerByWidget 是否由子widget通过事件触发
 */
ad.widget.imageplus.m.BaseBox.prototype.hideContent = function (opt_done, opt_triggerByWidget) {
    var me = this;
    var root = me.getRoot();
 ...
 * @param {boolean=} opt_triggerByWidget 是否由子widget通过事件触发
 */
ad.widget.imageplus.m.BaseBox.prototype.hideContentFx = function (root, done, opt_triggerByWidget) {
 ...
 * @param {boolean=} opt_triggerByWidget 是否由子widget通过事件触发
 */
ad.widget.imageplus.m.BaseBox.prototype.showContent = function (opt_done, opt_triggerByWidget) {
    var me = this;
    var root = me.getRoot();
 ...
 * @param {boolean=} opt_triggerByWidget 是否由子widget通过事件触发
 */
ad.widget.imageplus.m.BaseBox.prototype.showContentFx = function (root, done, opt_triggerByWidget) {
 ...
 *     }
 */
ad.widget.imageplus.m.BaseBox.prototype.getAdRect = function () {
