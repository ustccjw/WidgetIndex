...
/**
 * src/ad/widget/tieba/ping_an_pb.js ~ 2012/11/13 15:16:44
...
goog.include('ad/widget/tieba/ping_an_pb.less');
goog.include('ad/widget/tieba/ping_an_pb.html');

goog.provide('ad.widget.tieba.PingAnPb');
 ...
 */
ad.widget.tieba.PingAnPb = function (data) {
     ...
     * @type {string}
     */
    this._view = 'AD_ad_widget_tieba_ping_an_pb';
};
baidu.inherits(ad.widget.tieba.PingAnPb, ad.widget.Widget);

/** @override */
ad.widget.tieba.PingAnPb.prototype.patchData = function () {
    if (this._data) {
        // 处理城市的数据
        var processor = new ad.widget.tieba.PingAnPb.Processor();
        processor.process();
...
/** @override */
ad.widget.tieba.PingAnPb.prototype.enterDocument = function () {
    var me = this;
    ad.widget.tieba.PingAnPb.superClass.enterDocument.call(me);

    me.form = baidu.g('ping-an-pb-form');
    me.provinceSelect = baidu.g('ping-an-pb-province-select');
    me.citySelect = baidu.g('ping-an-pb-city-select');
    me.priceInput = baidu.g('ping-an-pb-price-input');
    me.licenseInput = baidu.g('ping-an-pb-license-input');
    me.yearSelect = baidu.g('ping-an-pb-year-select');
    me.monthSelect = baidu.g('ping-an-pb-month-select');
    me.phoneInput = baidu.g('ping-an-pb-phone-input');
    me.provinceNameInput = baidu.g('ping-an-pb-province-name');
    me.cityNameInput = baidu.g('ping-an-pb-city-name');

};

/** @override */
ad.widget.tieba.PingAnPb.prototype.bindEvent = function () {
    var me = this;
    ad.widget.tieba.PingAnPb.superClass.bindEvent.call(me);
    ...
    baidu.on('ping-an-pb-submit', 'click', function (event) {
        event = event || window.event;
        if (me.validate()) {
            me.exchangeCharset();
            me.form.submit();
    ...
    for (var i = 0, l = inputs.length; i < l; i++) {
        ...
        baidu.on(input, 'focus', function(event) {
            var elem = this;
            baidu.dom.removeClass(elem, 'ec-ping-an-pb-empty');
        ...
        baidu.on(input, 'blur', function() {
            var elem = this;
            if (!elem.value) {
                baidu.dom.addClass(elem, 'ec-ping-an-pb-empty');
 ...
 * @private
 */
ad.widget.tieba.PingAnPb.prototype.exchangeCharset = function () {
    var me = this;
    var charset;
    if (baidu.browser.ie
        && me._data.charset
...
ad.widget.tieba.PingAnPb.prototype.onSubmitSuccess = function () {
    var me = this;
    ...
    baidu.dom.addClass(me.priceInput, 'ec-ping-an-pb-empty');
 ...
 */
ad.widget.tieba.PingAnPb.prototype.validate = function () {
    var me = this;
 ...
 * @return {boolean} true为正确，false为错误
 */
ad.widget.tieba.PingAnPb.prototype.validatePhone = function (value) {
    if (!value) {
        return false;
    }
 ...
 */
ad.widget.tieba.PingAnPb.prototype.showTip = function (dom, str) {
    var me = this;
    var main = baidu.g('ping-an-pb-main'),
        tip = baidu.g('ping-an-pb-tip'),
        iframe = baidu.g('ping-an-pb-iframe'),
    ...
    tip.style.width = width - 2 + 'px';
    tip.innerHTML = str;
    iframe.style.width = dom.offsetWidth + 'px';

    tip.style.display = iframe.style.display = 'block';
    if (me.prevDom) {
 ...
 */
ad.widget.tieba.PingAnPb.Province = function (id, name) {
    this._id = id;
    this._name = name;
...
/**
 * 添加该省城市
 * @param {ad.widget.tieba.PingAnPb.City} city 该省的城市
 */
ad.widget.tieba.PingAnPb.Province.prototype.add = function (city) {
 ...
 */
ad.widget.tieba.PingAnPb.City = function (id, name, carNo) {
    this._id = id;
    this._name = name;
    this._carNo = carNo;
};
 ...
 * @constructor
 */
ad.widget.tieba.PingAnPb.Processor = function () {
    /* jshint ignore:start */
 ...
 * 处理省市字符串
 */
ad.widget.tieba.PingAnPb.Processor.prototype.process = function () {
    var me = this;
    ...
    for (var i = 0, l = me._items.length; i < l; i++) {
        ...
        for (var j = 0, len = sCities.length; j < len; j++) {
            ...
            if (j === 0) {
                province = new ad.widget.tieba.PingAnPb.Province(
                    cityAttr[0],
                    cityAttr[1]
                );
            ...
            city = new ad.widget.tieba.PingAnPb.City(
                cityAttr[0],
                cityAttr[1],
                cityAttr[2]
            );
