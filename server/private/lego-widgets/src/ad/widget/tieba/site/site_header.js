...
/**
 * src/ad/widget/tieba/site/site_header.js ~ 2013/04/03 13:46:13
...
goog.include('ad/widget/tieba/site/site_header.less');
goog.include('ad/widget/tieba/site/site_header.html');

goog.provide('ad.widget.tieba.site.SiteHeader');
 ...
 */
ad.widget.tieba.site.SiteHeader = function (data) {
     ...
     * @type {string}
     */
    this._view = 'AD_ad_widget_tieba_site_site_header';
};
baidu.inherits(ad.widget.tieba.site.SiteHeader, ad.widget.Widget);

/** @override */
ad.widget.tieba.site.SiteHeader.prototype.enterDocument = function () {
    ad.widget.tieba.site.SiteHeader.superClass.enterDocument.call(this);
...
/** @override */
ad.widget.tieba.site.SiteHeader.prototype.patchData = function () {
