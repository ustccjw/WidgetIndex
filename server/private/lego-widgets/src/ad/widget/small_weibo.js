 ...
 * $Id: small_weibo.js 9823 2012-06-19 02:51:16Z fanxueliang $
 *
 **************************************************************************/
...
/**
 * src/ad/widget/small_weibo.js ~ 2012/06/07 22:07:55
...
goog.include('ad/widget/small_weibo.html');
goog.include('ad/widget/small_weibo.less');

goog.provide('ad.widget.SmallWeibo');
 ...
 */
ad.widget.SmallWeibo = function(data) {
    ad.widget.Widget.call(this, data);
    this._view = 'AD_ad_widget_small_weibo';
     ...
     * @type {string}
     */
    this.customContextTitle2Prx = 'weibo-link';
...
baidu.inherits(ad.widget.SmallWeibo, ad.widget.Widget);

/**
 * 微博接口
 * @type {Object}
 */
ad.widget.SmallWeibo.prototype._remoteApi = {
 ...
 * @return {String}      调用URL
 */
ad.widget.SmallWeibo.prototype._getRemoteApiUrl = function(name, data) {
    var url = '';
 ...
 * @override
 */
ad.widget.SmallWeibo.prototype.enterDocument = function() {
    ad.widget.SmallWeibo.superClass.enterDocument.call(this);
    var me = this;

    var url = this._getRemoteApiUrl('userTimeline', { 'id': me._data['id'] });
    me._data['id'] && baidu.sio.callByServer(url, function(sResult, bStatus) {
 ...
 * @private
 */
ad.widget.SmallWeibo.prototype.patchData = function() {
    if (this._data) {
        if (this._data['id']) {
            this._data['id'] += '';
        ...
        // 如果icon和icon_rcv_url其中一个没有那么不显示icon
        if (!this._data['icon'] || !this._data['icon_rcv_url']) {
 ...
 */
ad.widget.SmallWeibo.prototype._parseStrToDate = function(str) {
    var month = {
        'Jan': '1月',
        'Feb': '2月',
        'Mar': '3月',
 ...
 */
ad.widget.SmallWeibo.prototype._stringLengthFormat = function(str, len) {
 ...
 */
ad.widget.SmallWeibo.prototype._stringTransmitionFormat = function(str, len) {
 ...
 * @return {string} 截取后的微博内容.
 */
ad.widget.SmallWeibo.prototype._weiboContentFormat = function() {
    var text;
    if (this.weiboResult['retweeted_status']) {
        text = this._stringLengthFormat(this.weiboResult['text'], Math.round(this._data['weibo_context_length'] / 2));
        text += '<br/>';
 ...
 *
 */
ad.widget.SmallWeibo.prototype._weiboAddAttention = function() {
    var me = this;
 ...
 *
 */
ad.widget.SmallWeibo.prototype._weiboStore = function() {
    var me = this;
 ...
 * 登陆状态
 */
ad.widget.SmallWeibo.prototype['loginStatus'] = false;
/**
 * 检查登陆状态
 * @return {boolean} 登陆状态
 */
ad.widget.SmallWeibo.prototype.checkLogin = function() {
    var me = this;
 ...
 */
ad.widget.SmallWeibo.prototype.login = function(opt_callback) {
    var me = this;
    if (!me.checkLogin()) {
 ...
 *
 */
ad.widget.SmallWeibo.prototype.bindEvent = function() {
    var me = this;
    baidu.on(baidu.g(me.getId('name')), 'click', function() {
        me.trigger(ui.events.WEIBO_NAME);
    });

    if (baidu.g(this.getId('follow'))) {
    ...
    if (me._data['is_display_foot']) {
        baidu.on(baidu.g(me.getId('transformation')), 'click', function(e) {
            ...
            var context = '//@' + me.weiboResult['user']['name']
                ...
                + (me.weiboResult['retweeted_status'] ? ('&' + me.weiboResult['retweeted_status']['text']) : '');
            var pic = '';
 ...
 * @override
 */
ad.widget.SmallWeibo.prototype.dispose = function() {
    window['sinaWB'] = null;
    window['WB'] = null;
    ad.widget.SmallWeibo.superClass.dispose.call(this);
};
