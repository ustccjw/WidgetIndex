...
/**
 * src/ad/widget/siva/video_big.js ~ 2013/10/14 10:17:12
...
goog.include('ad/widget/siva/video_big.less');
goog.include('ad/widget/siva/video_big.html');

goog.provide('ad.widget.siva.Video_big');
 ...
 */
ad.widget.siva.Video_big = function(data) {
     ...
     * @type {string}
     */
    this._view = 'AD_ad_widget_siva_video_big';
...
baidu.inherits(ad.widget.siva.Video_big, ad.widget.Widget);

/** @override */
ad.widget.siva.Video_big.prototype.enterDocument = function() {
    ad.widget.siva.Video_big.superClass.enterDocument.call(this);
    this.enterDocumentInternal();
};

/** @override */
ad.widget.siva.Video_big.prototype.bindEvent = function() {
    ad.widget.siva.Video_big.superClass.bindEvent.call(this);
    var me = this;
...
/** @override */
ad.widget.siva.Video_big.prototype.patchData = function() {
    if (this._data) {
        this._data['toolHeight'] = 20;
        this._data['width'] = 270;
        this._data['height'] = 220;
 ...
 */
ad.widget.siva.Video_big.prototype.enterDocumentInternal = function() {
    var me = this;
    this.videoContainer = baidu.g(this.getId('video-container'));
    this.videoBox = baidu.g(this.getId('video-box'));
 ...
 * Zoom in the Video.
 */
ad.widget.siva.Video_big.prototype.zoomIn = function() {
    ...
    baidu.dom.addClass(this.videoBox, 'ad-widget-siva-video-open-status');
    this.hasZoomIn = true;
};
 ...
 * Zoom out the Video.
 */
ad.widget.siva.Video_big.prototype.zoomOut = function() {
    ...
    baidu.dom.removeClass(this.videoBox, 'ad-widget-siva-video-open-status');
 ...
 */
ad.widget.siva.Video_big.prototype.play = function() {
    this.charge('hide');
    var $container = baidu.g('container'), zoomIn = false;
    if ($container && baidu.dom.hasClass($container, 'container_l')) {
        zoomIn = true;
    }
 ...
 */
ad.widget.siva.Video_big.prototype.stop = function() {
    if (this.hasZoomIn) {
        this.zoomOut();
    }
    this.stopLog();
 ...
 */
ad.widget.siva.Video_big.prototype.pause = function() {
 ...
 */
ad.widget.siva.Video_big.prototype.log = function(data) {
    var logData = baidu.object.extend({
        'qid': (window['bds'] && window['bds']['comm'] && window['bds']['comm']['qid']) || 'noqid',
        'tag': 'siva-video',
        't': (new Date).getTime()
    }, data), params = [], key, url = 'http://fclick.baidu.com/w.gif?';
    for (key in logData) {
 ...
 * Send start log.
 */
ad.widget.siva.Video_big.prototype.startLog = function() {
    var me = this;
    me.log({
        'type': 'start',
        'time': me.playTime
 ...
 * Send stop log.
 */
ad.widget.siva.Video_big.prototype.stopLog = function() {
    ad.base.clearInterval(this.logTimer);
    this.log({
        'type': 'stop',
        'time': this.playTime
 ...
 */
ad.widget.siva.Video_big.prototype.createFlash = function(options, vars) {
 ...
 */
ad.widget.siva.Video_big.prototype.charge = function(type) {
    var me = this;
    ad.base.setTimeout(function() {
        ...
        if ('newWindow' == type) {
            ...
            var img = document.createElement('img');
            img.src = url;
            ad.widget.siva.Video_big['img' + me.getId()] = img.src;
        }
    }, 50);
};
 ...
 * @override
 */
ad.widget.siva.Video_big.prototype.dispose = function() {
    if (this.logTimer) {
        ad.base.clearInterval(this.logTimer);
        this.logTimer = null;
    }
    ad.widget.siva.Video_big.superClass.dispose.call(this);
}
