...
/**
 * src/ad/plugin/impl/video_powerlink_basic2.js ~ 2013/07/25 10:03:54
 * @author leeight(liyubei@baidu.com)
 * @version $Revision$ 
 * @description 说明：跟basic的区别是，浮层里是flash
 *  
 **/
goog.require('ad.plugin.Plugin');
goog.require('ad.widget.Flash');

goog.provide('ad.plugin.impl.VideoPowerlinkBasic2');
 ...
 * @constructor
 */
ad.plugin.impl.VideoPowerlinkBasic2 = function() {
    ad.plugin.Plugin.call(this);
};
baidu.inherits(ad.plugin.impl.VideoPowerlinkBasic2, ad.plugin.Plugin);
ad.plugin.Plugin.register(new ad.plugin.impl.VideoPowerlinkBasic2());

/** @expose */
ad.plugin.impl.VideoPowerlinkBasic2.prototype.attachTo = function(material) {
    material.addListener(ui.events.BEFORE_MATERIAL_SHOW, function() {
        ...
        var flash = new ad.widget.Flash(AD_CONFIG['3']);
