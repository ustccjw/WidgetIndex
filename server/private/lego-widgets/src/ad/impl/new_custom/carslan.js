...
/**
 * src/ad/impl/new_custom/carslan.js ~ 2014/08/18 15:47:26
...
goog.include('ad/impl/new_custom/carslan.less');

goog.provide('ad.impl.new_custom.Carslan');
...
ad.Debug(function(async) {
    ...
    var normalContainer;
    // var temp;
    baidu.each(AD_CONFIG['tab_container']['options'], function(option, index) {
