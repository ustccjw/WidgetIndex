 ...
 * $Id: yaying.js 11222 2012-08-20 02:53:59Z liyubei $
 *
 **************************************************************************/


/**
 * src/ad/impl/new_custom/yaying.js ~ 2013-11-04 14:22:11
...
goog.include('ad/impl/new_custom/yaying.less');

goog.provide('ad.impl.new_custom.Yaying');
    ...
    material.setWidgets(
        ...
        [
            ...
            [
                ...
                new ad.widget.Image(AD_CONFIG['product_img'])
            ]
        ],
