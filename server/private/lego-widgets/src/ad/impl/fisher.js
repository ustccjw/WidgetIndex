 ...
 * $Id: fisher.js 11222 2012-08-20 02:53:59Z fanxueliang $
 *
 **************************************************************************/
...
/**
 * src/ad/impl/fisher.js ~ 2012/09/27 14:17:21
...
goog.include('ad/impl/fisher.less');

goog.provide('ad.impl.Fisher');
...
ad.Debug(function(async) {
    ...
    AD_CONFIG['fwc']['material_name'] = 'ec-fisher';
    AD_CONFIG['fwc']['id'] = 1;
    ...
    // FIXME(user)
    AD_CONFIG['tab']['options'].unshift({'tab_title': '官方微博'});
