...
var AD_TEMPLATE_CONTENT="<!-- target:AD_ad_widget_xlab_iknow -->\n<div class=\"ad-widget ad-widget-xlab-iknow\">\n    <a class=\"logo\" target=\"_blank\" href=\"{{logo_url}}\" style=\"filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='{{logo_image_url}}', sizingMethod='scale');\"><img src=\"{{logo_image_url}}\"/></a>\n    {{#products}}\n    <div class=\"figure\">\n        <a target=\"_blank\" href=\"{{url}}\" title=\"{{name}}\">&nbsp;</a>\n        <div class=\"image\" style=\"filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='{{image_url}}', sizingMethod='scale');\"><img src=\"{{image_url}}\" width=\"138\" height=\"83\"></div><div class=\"figcaption\">{{price}}</div>\n    </div>\n    {{/products}}\n</div>\n";;
var AD_STYLE_CONTENT="/*! Copyright 2012 Baidu Inc. All Rights Reserved. */\n.ad-widget-xlab-iknow{font-family:arial,sans-serif;background:url(//bs.baidu.com/adtest/77122cbf3d35ed9b458511b2d410a7d0.png) no-repeat;width:760px;height:83px;padding:3px 0 4px 5px;*zoom:1}.ad-widget-xlab-iknow:before,.ad-widget-xlab-iknow:after{display:table;content:\"\"}.ad-widget-xlab-iknow:after{clear:both}.ad-widget-xlab-iknow .logo{float:left;margin-right:5px;width:100px;height:83px;cursor:pointer}.ad-widget-xlab-iknow .logo img{width:100px;height:83px;border:0}.ie6 .ad-widget-xlab-iknow .logo img{display:none}.ad-widget-xlab-iknow .figure,.ad-widget-xlab-iknow .figcaption{margin:0;padding:0;float:left}.ad-widget-xlab-iknow .figure{width:215px;cursor:pointer;position:relative}.ad-widget-xlab-iknow .figure a{text-decoration:none;display:inline-block;zoom:1;position:absolute;z-index:100;width:200px;height:80px;left:15px;background:white;opacity:0;filter:alpha(opacity=0)}\n.ad-widget-xlab-iknow .image{float:left;width:138px;height:83px;overflow:hidden;text-align:center}.ie6 .ad-widget-xlab-iknow .image img{display:none}.ad-widget-xlab-iknow .figcaption{padding:37px 0 0 27px;color:white;font-family:arial,'Microsoft YaHei','\u9ed1\u4f53',sans-serif;font-size:16px}#canvas{width:760px;height:90px;overflow:hidden}";;
...
h.prototype.parse = function(a) {
  ...
  for(var a = a.split(/\r?\n/), e = a.length, g = 0, i = /<\!--\s*target:\s*([a-zA-Z0-9_]+)\s*--\>/, v = /<\!--\s*\/target\s*--\>/, u = /<\!--\s*import:\s*([a-zA-Z0-9_\/]+)\s*--\>/, w = /<\!--\s*scope:\s*([a-zA-Z0-9_]+)\s*--\>/, D = /<\!--\/scope--\>/, m, f, j, o, q = this.j, r = [], k, l = {};g < e;g++) {
...
function t(a) {
  this.m = [];
  this.l = a;
  this.d = "ad-w-" + Math.floor(2147483648 * Math.random()).toString(36)
}
baidu.inherits(t, s);
function x(a) {
  if(!a.f) {
  ...
  var c = n.get(a.f), b = baidu.extend(a.l, {_id:function() {
    return function(b) {
      return a.c(b)
    }
  }});
...
function y(a) {
  t.call(this, a);
  this.f = "AD_ad_widget_xlab_iknow"
}
baidu.inherits(y, t);
function z() {
}
z.prototype.k = baidu.abstractMethod;
function A() {
}
baidu.inherits(A, z);
...
function C(a, c) {
  for(var b = 0, d = a.h;b < d.length;b++) {
...
B.prototype.show = function() {
  ...
  var a = this.n.k(this.h), c = this.a();
  c && (c.innerHTML = a);
  C(this, function(a) {
    a.p()
  });
...
var E = new B(AD_CONFIG_720x90.id);
E.r([new y(AD_CONFIG_720x90.iknow)]);
E.show();
