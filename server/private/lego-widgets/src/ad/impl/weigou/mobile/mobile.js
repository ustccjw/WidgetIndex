...
/**
 * src/ad/impl/weigou/mobile/mobile.js ~ 2013/04/02 17:56:01
 * @author pengxing@baidu.com (pengxing), wangyang02@baidu.com (firedfox)
...
goog.require('ad.widget.mweigou.PurchaseView');
goog.require('ad.widget.mweigou.SuccessView');
goog.require('ad.widget.mweigou.ViewContainer');

goog.include('ad/impl/weigou/mobile/mobile.less');

goog.provide('ad.impl.weigou.mobile.Weigou');
...
ad.Debug(function() {
    ...
    function gotoPurchase(result) {
        var purchaseView = new ad.widget.mweigou.PurchaseView(result);
    ...
    if (!COMPILED) {
        window.gotoSuccess = gotoSuccess;
    }
});
