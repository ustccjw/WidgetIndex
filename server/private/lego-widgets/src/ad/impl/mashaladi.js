 ...
 * $Id: mashaladi.js 11222 2012-08-20 02:53:59Z fanxueliang $
 *
 **************************************************************************/
...
/**
 * src/ad/impl/mashaladi.js ~ 2012/09/27 14:17:21
...
goog.include('ad/impl/mashaladi.less');

goog.provide('ad.impl.MaShaLaDi');

ad.Debug(function(async) {
    // FIXME(user) 便于定制每个浮层的样式，以物料名作限定以避免样式冲突
    AD_CONFIG['fwc']['material_name'] = 'ec-mashaladi';
    AD_CONFIG['fwc']['id'] = 1;
    
    var material = new ad.material.BaseMaterial();
    
    var fwc = new ad.widget.FloatWindowContainer(AD_CONFIG['fwc']);
    AD_CONFIG['fwc_map']['material_name'] = 'ec-mashaladi-map';
