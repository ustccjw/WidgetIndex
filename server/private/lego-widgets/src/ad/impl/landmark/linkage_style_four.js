 ...
 * $Id: linkage_style_four.js 12406 2012-09-28 03:46:29Z fanxueliang $
 *
 **************************************************************************/
...
/**
 * src/ad/impl/landmark/linkage_style_four.js ~ 2012/09/28 11:32:23
 * @author fanxueliang@baidu.com (fanxueliang)
 * @version $Revision: 12406 $
 * @description
 * linkage_style_four相关的实现逻辑
 **/
...
goog.include('ad/impl/landmark/linkage_style_four.less');

goog.provide('ad.impl.landmark.LinkageStyleFour');

ad.Debug(function(async) {
    var material = new ad.Material(AD_CONFIG['id']);
    material.setWidgets(
        [new ad.widget.VideoTitle(AD_CONFIG['title'])],
        [new ad.widget.ImageShowVertical(AD_CONFIG['tabs'])],
