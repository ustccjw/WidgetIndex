...
goog.require('ad.widget.zhidao.Head');
goog.require('ad.widget.Colorlist');

goog.include('ad/impl/zhidao/powerlink.less');

goog.provide('ad.impl.zhidao.Powerlink');

ad.Debug(function(async){
    var material = new ad.material.BaseMaterial();
    material.setWidgets(
        [new ad.widget.zhidao.Head(AD_CONFIG['head'])],
