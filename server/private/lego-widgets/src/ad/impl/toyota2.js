...
/**
 * src/ad/impl/toyota2.js ~ 2014/05/26 15:50:54
...
goog.include('ad/impl/toyota2.less');

goog.provide('ad.impl.Toyota2');
...
ad.Debug(function(async) {
    ...
    AD_CONFIG['fwc']['material_name'] = 'ec-toyota';
    AD_CONFIG['fwc']['id'] = 1;
    ...
    material.setWidgets(
        [leftVideo, smallHead], [tabContainer], [new ad.widget.ButtonGroup(AD_CONFIG['button_group'])], [fwc]
    );
