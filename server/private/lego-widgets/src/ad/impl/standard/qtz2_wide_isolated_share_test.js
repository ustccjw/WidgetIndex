...
/**
 * src/ad/impl/standard/qtz2_wide_isolated_share_test.js ~ 2014/08/26 16:38:07
 * @author hekai02@baidu.com (Kyle He)
 * @version $Revision: 11222 $
 * @description
 * 高级版右侧擎天柱（宽版）的样式包含如下的功能：
...
goog.require('ad.widget.BaiduShareIsolation');
...
goog.include('ad/impl/standard/qtz2_wide_isolated_share_test.less');

goog.provide('ad.impl.standard.Qtz2WideIsolatedShareTest');
...
ad.Debug(function(async) {
    ...
    if ('true' in shareButton) {
        ...
        widgets.push(new ad.widget.BaiduShareIsolation(config));
    }
