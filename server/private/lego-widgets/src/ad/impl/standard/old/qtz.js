...
/**
 * src/ad/impl/standard/old/qtz.js ~ 2013/10/21 14:26:23
...
goog.include('ad/impl/standard/old/qtz.less');

goog.provide('ad.impl.standard.old.Qtz');
...
ad.Debug(function(async) {
    ...
    if ('true' in shareButton) {
        ...
        widgets.push(new ad.widget.BaiduShare(config));
    }
