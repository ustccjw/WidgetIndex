...
/**
 * src/ad/impl/hp.config.js ~ 2012/09/06 12:36:23
...
var AD_CONFIG = {
        ...
        'options':[
            {
                ...
                'section' : {
                    'options' : [
                        {
                            'icon_url' : 'http://eiv.baidu.com/mapm2/hp/icon-green.png',
                            'text' : '活动有份-参与活动立取300元优惠券',
                            'text_url' : 'www.baidu.com'
                        },
                        {
                            'icon_url' : 'http://eiv.baidu.com/mapm2/hp/icon-red.png',
                            'text' : '搭伙有礼-邀请参团即抢100份惠普大礼！',
                            'text_url' : 'www.baidu.com'
                        },
                        {
                            'icon_url' : 'http://eiv.baidu.com/mapm2/hp/icon-blue.png',
                            'text' : '参团逆袭-下单立即获600代金券',
                            'text_url' : 'www.baidu.com'
                        }
                    ]
            ...
            {
                'pro_img_url' : 'http://eiv.baidu.com/mapm2/bmw/120523_pl_01/sp.jpg',
    ...
    'h1':{
        'url' : 'http://www.baidu.com',
        'title' : '<em>惠普</em>(中国)官方在线商店',
        'description' : '如何能彻底告别暗沉，赢得真正水润透白美肌？OLAY水感透白系列，淡化色斑，焕发水感透白。双天后热荐NO.1美白水，含高浓度美白精华，补充肌肤水分同时打开护肤美白通道。补水保湿又美白的爆水凝乳同期全新上市，开启水感、通透、白皙的新境界。',
        'site' : 'www.olay.com.cn',
        'logo' : 'http://dummyimage.com/90x90',
