 ...
 * $Id: case10000.js 150523 2012-10-30 10:06:05Z  $
 *
 **************************************************************************/
...
/**
 * src/ad/impl/video/case10000.js ~ 2013/09/26 18:37:29
...
goog.include('ad/impl/video/case10000.less');

goog.provide('ad.impl.video.Case10000');

ad.Debug(function(async){
    var material = new ad.material.BaseMaterial();
    var fwc = new ad.widget.FloatWindowContainer(AD_CONFIG['4']);
    var fwcVideo = new ad.widget.Video(AD_CONFIG['5']);
    ...
    fwcVideo.addListener(ui.events.VIDEO_CLICK, function(){
        fwcVideo.sendLog('videojump', 'videojump');
        return false;
    });
    ...
    function showFWC() {
        ...
        fwc.show();
        if(fwcVideo) {
            fwcVideo.refresh(null, AD_CONFIG['5']);
        }
        if (!fwcRenderd) {
