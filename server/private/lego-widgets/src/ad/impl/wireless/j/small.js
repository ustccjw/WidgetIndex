...
/**
 * src/ad/impl/wireless/j/small.js ~ 2013/12/26 15:22:11
...
goog.include('ad/impl/wireless/j/small.less');

goog.provide('ad.impl.wireless.j.Small');
...
ad.Debug(function(async) {
    ...
    for (var i = 0, len = plist.length;i < len;i++) {
        ...
        plist[i]['title'] = ad.base.subByte(plist[i]['title'], 60, '..');
    }

    if (AD_CONFIG['links']['options'].length >= 3) {
        AD_CONFIG['links']['options'].splice(2, 1);
    }
