...
/**
 * src/ad/impl/zhixin/cosmetic/style2.config.js ~ 2013/10/31 20:56:26
...
var AD_CONFIG = {
    ...
    "rank": {
        ...
        ranks: [{
            ...
            text: "polo",
            text_rcv_url: "http://www.baidu.com/s?ie=utf-8&bs=polo&f=8&rsv_bp=1&rsv_spt=3&wd=polo&inputT=0",
            rate: "33987"
        }, {
            text: "高尔夫",
            text_rcv_url: "http://www.baidu.com/s?ie=utf-8&bs=%E9%AB%98%E5%B0%94%E5%A4%AB&f=8&rsv_bp=1&rsv_spt=3&wd=%E9%AB%98%E5%B0%94%E5%A4%AB&inputT=0",
            rate: "31027"
        }],
        foot: [{
            text: "百度风云榜",
    ...
    "products": {
        ...
        "options": [
            {
                "title": "香水系列",
                "links": [
                    {"rcv_url": "http://z.baidu.com", "text": "煽动系列"},
                    {"rcv_url": "http://z.baidu.com", "text": "真爱煽动"},
                    {"rcv_url": "http://z.baidu.com", "text": "神仙水"}
                ]
            },
            {
                "title": "彩妆系列",
        ...
        "more_url": {
            "rcv_url": "http://1.baidu.com",
            "text": "http://z.baidu.com"
        }
    }
};
