 ...
 * $Id: bjxd2.js 11222 2012-08-20 02:53:59Z fanxueliang $
 *
 **************************************************************************/
...
/**
 * src/ad/impl/bjxd2.js ~ 2012/09/27 14:17:21
...
goog.require('ad.widget.PageableTabContainer');
...
goog.include('ad/impl/bjxd2.less');

goog.provide('ad.impl.BJXD2');

ad.Debug(function(async) {
    AD_CONFIG['fwc']['material_name'] = 'ec-bj-xiandai'; //便于定制每个浮层的样式，以物料名作限定以避免样式冲突
    AD_CONFIG['fwc']['id'] = 1;
    ...
    var pageable_tab_container = new ad.widget.PageableTabContainer(AD_CONFIG['tab']);
    pageable_tab_container.setWidgets(arr_tab_cont);
    
    material.setWidgets(
        [leftVideo,smallHead],
        [pageable_tab_container],
    ...
    pageable_tab_container.addListener(ui.events.TAB_HOVER, function() {
        return false;
    });
