 ...
 * $Id: yili.js 9564 2012-06-06 04:43:29Z fanxueliang $
 *
 **************************************************************************/
...
/**
 * src/ad/impl/yili.js ~ 2012/06/06 11:47:13
...
goog.include('ad/impl/yili.less');

goog.provide('ad.impl.YiLi');

ad.Debug(function(async) {
    var material = new ad.Material(AD_CONFIG['id']);
    material.setRender(new ad.render.RecursiveRender());
    material.setWidgets(
        [new ad.widget.Video(AD_CONFIG['left_video']), new ad.widget.SmallHead(AD_CONFIG['head'])],
        [new ad.widget.Section(AD_CONFIG['columns'])],
    ...
    material.initHMJSMoniter('f4d34c185fc48c0ac0fd5e4c6c31ebb9');
