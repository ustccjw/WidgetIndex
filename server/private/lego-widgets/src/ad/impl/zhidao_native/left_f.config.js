...
/**
 * src/ad/impl/zhidao_native/left_f.config.js ~ 2014/04/16 15:56:02
...
var AD_CONFIG = {
    "cid": {
        "logo_src": 'http://dummyimage.com/50x35/ccc/999.png',
        "company_name": "百度中国",
        "company_rcv_url": "http://www.baidu.com"
    },
    "product": {
        "company_title": "企业产品",
        "products": [
            {
                "img_src": "http://dummyimage.com/133x91/ccc/999.png",
    ...
    "video_desc": {
        "rcv_url": "http://baidu.com",
        "rcv_html": "宾利汽车(Bentley),顶级英国豪华车,手工打造传世最佳豪华轿车.宾利新飞驰V8,锐意创领豪华运动型轿车新典范"
    },
    'video_thumbs': {
        'options': [
            {
                'display_playing_tip': true,
                'img_url': 'http://placehold.it//101x75/ccc/999.png',
    ...
    'fwc': [
        ...
        },
        {
            ...
            'video': {
                ...
                'video_url': "//bs.baidu.com/adtest/97f6e2fb6bcf5152cf817b25061aa3d7.flv",
