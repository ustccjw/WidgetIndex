...
/**
 * src/ad/impl/imageplus/flag_helper.js ~ 2014/03/05 15:48:00
 * @author zhouminming01@baidu.com (zhouminming01)
 * @version $Revision: 150523 $
 * @description
 * impl的相关帮助函数
 **/
goog.require('ad.widget.imageplus.FlagBox');
...
goog.provide('ad.impl.imageplus.flagHelper');

ad.impl.imageplus.flagHelper = {
    /**
     * 创建icon类型的广告
     *
    ...
    createFlagAd: function (Widget, opt_option) {
        ...
        return function (opt_async) {
            ...
            function rendAd() {
                ...
                box = new ad.widget.imageplus.FlagBox(adConfig);
