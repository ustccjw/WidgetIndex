...
/**
 * src/ad/impl/imageplus/v2/icon_helper.js ~ 2014/06/13 15:48:00
 * @author zhouminming01@baidu.com (zhouminming01)
 * @version $Revision: 150523 $
 * @description
 * impl的相关帮助函数
 **/
goog.require('ad.widget.imageplus.v2.IconBox');
...
goog.provide('ad.impl.imageplus.v2.iconHelper');

ad.impl.imageplus.v2.iconHelper = {
    /**
     * 创建icon类型的广告
     *
     ...
     * @param {function(Object, ad.widget.imageplus.v2.IconBox)=} opt_option.after 执行后回调
    ...
    createIconAd: function (Widget, opt_option) {
        ...
        return function (opt_async) {
            ...
            function rendAd() {
                ...
                box = new ad.widget.imageplus.v2.IconBox(adConfig);
