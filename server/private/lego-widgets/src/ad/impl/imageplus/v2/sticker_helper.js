...
goog.provide('ad.impl.imageplus.v2.stickerHelper');

ad.impl.imageplus.v2.stickerHelper = {
    /**
     * 创建icon类型的广告
     *
     ...
     * @param {function(Object, ad.widget.imageplus.StickerBox)=} opt_option.after 执行后回调
    ...
    createStickerAd: function (Widget, opt_option) {
        ...
        return function (opt_async) {
            ...
            function rendAd() {
                ...
                box = new ad.widget.imageplus.v2.StickerBox(adConfig);
