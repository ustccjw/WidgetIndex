...
/**
 * src/ad/impl/imageplus/v2/sticker/reel_pa.config.js ~ 2014/09/04 00:03:47
...
var AD_CONFIG = {
    "box": {
        'box_bg_opacity': 0,       // 背景透明度
        'has_close_btn': true,       // 背景透明度
        'hover_height': 80,           // 鼠标放在图片上之后广告的高度
        'normal_height': 80,          // 默认情况下的广告高度
