...
/*
 * path:    src/ad/impl/imageplus/v2/rolling_helper.js
 * author:  zhouminming01@baidu.com
 * version: $Revision$
 */

goog.require('ad.widget.imageplus.v2.RollingBox');
goog.require('ad.plugin.imageplus.Log');
goog.require('ad.material.ImageplusMaterial');

goog.provide('ad.impl.imageplus.v2.rollingHelper');

ad.impl.imageplus.v2.rollingHelper = {
    /**
     * 创建icon类型的广告
     *
    ...
    createRollingAd: function (Widget, opt_option) {
        ...
        return function (opt_async) {
            ...
            function rendAd() {
                ...
                box = new ad.widget.imageplus.v2.RollingBox(adConfig);
