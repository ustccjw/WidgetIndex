...
goog.provide('ad.service.SivaClickService');
 ...
 */
ad.service.SivaClickService = function(opt_product) {
...
baidu.inherits(ad.service.SivaClickService, ad.service.Service);

/**
 * @param {Node} target 链接地址.
 * @private
 */
ad.service.SivaClickService.prototype._analyzeAnchor = function(target) {
 ...
 */
ad.service.SivaClickService.prototype.init = function(parameters, opt_mainUrl) {
    ...
    for (var i = 0, link = null; link = links[i]; i++) {
        link.setAttribute('data-p1', 6001);
